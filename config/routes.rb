...
Rails.application.routes.draw do
  ...
  namespace :api do
    api_version(module: "V1", header: {name: "Accept", value: "application/vnd.api+json; version=1"}) do
      ...
      json_api_resources :projects, links: [:subject_sets, :workflows, :gamified_workflows], versioned: true do
      ...
      json_api_resources :gamified_projects, links: [:subject_sets, :workflows, :gamified_workflows], versioned: true do
        media_resources :avatar, :background, :attached_images,
                        classifications_export: { except: [:create] },
                        subjects_export: { except: [:create] },
                        aggregations_export: { except: [:create] },
      ...
      json_api_resources :gamified_workflows, links: [:subject_sets, :retired_subjects], versioned: true do
        media_resources :attached_images

        post "/retired_subjects", to: "gamified_workflows#retire_subjects"
      end
